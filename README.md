**NOTE:** If you want to use the [react-navigation-v3](https://reactnavigation.org/docs/en/getting-started.html) you should use this one: [react-native-redux-navigation-v3-boilerplate](https://github.com/jayzyaj/react-native-redux-navigation-v3-boilerplate)
